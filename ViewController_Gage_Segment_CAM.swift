//
//  ViewController_Gage_Segment_CAM.swift
//  Socal_2106
//
...
class ViewController_Gage_Segment_CAM: UIViewController {
    ...
    var delegate: MyDataSendingDelegateProtocol? = nil
        ...
        public var resultcode : String = ""  // to pass data
        
        var overlay: UIView = UIView() //draw rectangle 1.1
        ...
        //          Draw a rectangle FOCUS
            ...
            extension ViewController_Gage_Segment_CAM : AVCaptureMetadataOutputObjectsDelegate {
                func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
                    ...
                    let dataToBeSent = self.resultcode
